...
--------------------------------------------------------
   ...
   (	
    ...
    ALTER TABLE J_ORDER ADD ORDER_CONTENT VARCHAR2(100 BYTE);
    ...
    ALTER TABLE J_ORDER DROP CONSTRAINT SYS_C007246;
...
--------------------------------------------------------
   ...
   ALTER TABLE J_REVIEW add ORDER_CONTENT VARCHAR2 (100 BYTE);
