...
public class MyPageController extends BaseController {
    ...
    public String getOrdersByMember(PageRequestDto pageRequestDto, HttpSession session, Model model)
            throws Exception {

        Pagination pagination = orderService.getPaginationOfOrdersByMember(session, pageRequestDto);
        List<OrderListDto> orders = orderService.getOrdersBySessionMemberAndPage(session, pagination);
